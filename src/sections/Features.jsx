...
//         <div className="relative flex md:flex-wrap flex-nowrap border-2 border-s3 rounded-7xl md:overflow-hidden max-md:flex-col feature-after md:h7 max-md:border-none max-md:rounded-none max-md:gap-3 ">
//           {features.map(({ icon, id, caption, title, text, button }) => (
//             <div
//               key={id}
